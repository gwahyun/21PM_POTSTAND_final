...
<body>
    ...
    justify-content: center;" >
			<textarea class="border-4 rounded-lg focus:outline-none" rows="10" cols="100%" name="answerContent" required=""></textarea>
			<br>	
			<input class="w-full flex justify-center bg-red-500 text-gray-100 p-4 rounded-full 
                    ...
                    cursor-pointer transition ease-in duration-300" type="button" value="답변" onclick="fn_reply();">
                    <br>
